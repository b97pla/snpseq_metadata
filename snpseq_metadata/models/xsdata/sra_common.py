...
class ReferenceAssemblyType:
    ...
    class Standard:
        ...
        :ivar accession: Identifies the genome assembly
    ...
    class Custom:
        """
        :ivar description: Description of the genome
            assembly.
        :ivar url_link: A link to the genome
            assembly.
        """
        ...
        class UrlLink:
            """
            :ivar label: Text label to display for the
                link.
            :ivar url: The internet service link
                (file:, http:, ftp:, etc).
            """
...
class SequencingDirectivesType:
    ...
    sample_demux_directive: Optional[
...
class SpotDescriptorType:
    ...
    class SpotDecodeSpec:
        ...
        :ivar spot_length: Number of base/color calls, cycles, or flows
            per                                    spot (raw sequence
            length or flow length including all
            application and technical tags and mate pairs, but not
            including                                    gap lengths).
            This value will be platform dependent, library
            dependent, and possibly run dependent. Variable length
            platforms                                    will still have
        ...
        class ReadSpec:
            ...
            :ivar relative_order: The read is located beginning at the
                offset or cycle relative to another read.   This choice
                is appropriate for example when specifying a read that
            ...
            expected_basecall_table: Optional[
...
class ProcessingType:
    ...
    :ivar directives: Processing directives tell the Sequence Read
        Archive how to                        treat the input data, if
        any treatment is requested.
    """
